...
class UdpIpEthTxTester:
    ...
    def gen_random_pkt(self):
        ...
        header = header / UDP(dport=dst_port_int, sport=src_port_int, chksum=0) # Udp checksum is unused
...
async def runUdpIpEthTxTester(dut):
    ...
    tester = UdpIpEthTxTester(dut, CASES_NUM, MIN_PAYLOAD_LEN, MAX_PAYLOAD_LEN)
