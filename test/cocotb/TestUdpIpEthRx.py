...
class UdpIpEthRxTester:
    def __init__(self, dut, cases_num, min_payload_len, max_payload_len):
        ...
        self.udp_meta_sink = UdpIpMetaDataSink(UdpIpMetaDataBus.from_prefix(dut, "m_udp_meta"), self.clock, self.resetn, False)
    ...
    async def check_mac_meta(self):
        ...
        for case_idx in range(self.cases_num):
            ...
            if not equal:
                print("Dut MacMetaData: ", dut_mac_meta)
                print("Ref MacMetaData: ", ref_mac_meta)
