...
UdpIpMetaDataBus, UdpIpMetaDataTransation, UdpIpMetaDataSource, UdpIpMetaDataSink, UdpIpMetaDataMonitor = define_stream(
    "UdpIpMetaData", signals=["valid", "ready", "ip_addr", "ip_dscp", "ip_ecn", "dst_port", "src_port", "data_len"]
)

MacMetaDataBus, MacMetaDataTransaction, MacMetaDataSource, MacMetaDataSink, MacMetaDataMonitor = define_stream(
    "MacMetaData", signals=["valid", "ready", "mac_addr", "eth_type"]
)

def is_udp_ip_meta_equal(dut:UdpIpMetaDataTransation, ref:UdpIpMetaDataTransation) -> bool:
